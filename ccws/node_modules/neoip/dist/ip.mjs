...
export { address, cidr, cidrSubnet, fromLong, fromPrefixLen, isEqual, isLinkLocal, isLoopback, isPrivate, isPublic, isReserved, isV4Format, isV6Format, loopback, mask, normalize, normalizeToLong, not, or, subnet, toBuffer, toLong, toString, toUInt8Array };
